...
Se deben instalar los paquetes y dependencias requeridas mediante el gestor de paquetes del entorno Node.js, ejecutando la descarga automática especificada en el archivo de configuración.
...
- Dirección del host de la base de datos (`DB_HOST`)
